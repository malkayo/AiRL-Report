...
class Trainer:
    def __init__(self):
        ...
        self.initial_runs = 20000
        self.max_exp_size = 250000
        ...
        self.select_size = 16  # minibatch size 32
        self.update_rate = 4  # 4 in DQN paper
        self.weight_update_rate = 10000  # 10,000 simu step according to literature on DQN
        ...
        self.gamma = .95
        self.exploration_steps = 20000.  # 1M simu step in DQN
        self.init_eps = 1
        self.final_eps = 0.05
